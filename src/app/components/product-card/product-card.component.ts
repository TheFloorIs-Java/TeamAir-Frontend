...
export class ProductCardComponent implements OnInit {
  ...
  /**
   * This method gets the cart to be populated from the Service layer and sets the values from
   * that cart to the variables declared in the class
   */
  ngOnInit(): void {
  ...
  addToCart(product: Product): void {
    //add to cart will only run under three conditions...
    ...
    if (this.quantity > 0) {
      ...
      if (this.quantity <= this.productInfo.quantity) {
        ...
        this.products.forEach((element) => {
          console.log(
            element.quantity + this.quantity > this.productInfo.quantity
          );
  ...
  /**
   * This method adds a review to a product if the message is not blank
   */
  addReview() {
    if (this.newMessage != '') {
  ...
  /**
   * This method sets the average rating of the product
  ...
  /**
   * This method sets the CSS class depending on the rating of a review
  ...
  /**
   * This method acts as a sorting function for Low to High Review List
   * @param a review 1
   * @param b review 2
  ...
  /**
   * This method acts as a sorting function for High to Low Review List
   * @param a review 1
   * @param b review 2
   * @returns the placement for the sorting function
   */
  ...
  /**
   * This method sorts the List of Reviews from lowest to highest rating
  ...
  /**
   * This method sorts the List of Reviews from highest to lowest rating
   * @param reviews list of reviews
   * @returns sorted list of reviews
   */
  ...
  /**
   * This method deletes a review based in its id and reloads the reviews
   * @param id review id
   */
